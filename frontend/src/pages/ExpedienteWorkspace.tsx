...
export const ExpedienteWorkspace: React.FC = () => {
  ...
  if (isLoading) {
    ...
    return (
      ...
      <div className="max-w-7xl mx-auto px-6 py-24 text-center space-y-4">
        ...
        <p className="text-ink-500 font-medium text-sm">Cargando Workspace del Expediente...</p>
  ...
  if (!expediente) {
    ...
    return (
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 text-center">
        ...
        <h2 className="text-xl font-bold text-ink-900">Expediente no encontrado</h2>
  ...
  const statusColors: Record<ExpedienteEstado, string> = {
    ...
    EN_VALIDACION: 'bg-amber-50 text-amber-700 border-amber-100',



    PENDIENTE_DOCUMENTACION: 'bg-indigo-50 text-indigo-700 border-indigo-500/20',



    LISTO_PARA_NEGOCIAR: 'bg-emerald-50 text-emerald-700 border-emerald-100',
    ...
    CERRADO: 'bg-slate-500/10 text-ink-500 border-slate-500/20',
    ...
    CANCELADO: 'bg-slate-700/10 text-ink-500 border-ink-300/20'
    ...
    <div className="max-w-7xl mx-auto px-6 py-8 animate-fade-in space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            ...
            className="flex items-center justify-center w-10 h-10 rounded-lg bg-ink-50 border border-ink-200 text-ink-500 hover:text-ink-900 hover:border-ink-300 transition-all duration-150"
          ...
          <div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold border font-mono ${isNewCase ? 'bg-ink-200 text-ink-500 border-ink-300' : statusColors[expediente.estado]}`}>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="px-4 py-2 rounded-xl bg-ink-50 border border-ink-200 text-xs font-medium text-ink-500 flex items-center gap-2">
            ...
            <span>Rol: <strong className="text-ink-700">{role === 'OPERADOR' ? 'Operador de Valores' : 'Oficial de Cumplimiento'}</strong></span>
          ...
          {!isNewCase && isOperador && expediente.estado !== 'CERRADO' && expediente.estado !== 'CANCELADO' && expediente.estado !== 'RECHAZADO' && (
            ...
            <button
              ...
              className="px-3.5 py-2 bg-white hover:bg-red-50 border border-ink-200 hover:border-red-500/40 text-ink-500 hover:text-red-700 rounded-xl text-xs font-semibold transition-all"
          ...
          {!isNewCase && isCumplimiento && expediente.estado === 'EN_VALIDACION' && (
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-3.5 py-2 bg-red-900/10 hover:bg-red-900/20 border border-red-200 text-red-700 rounded-xl text-xs font-semibold transition-all"
              ...
              <button
                ...
                className="px-3.5 py-2 bg-emerald-600 hover:bg-emerald-500 text-ink-900 rounded-xl text-xs font-semibold shadow-lg shadow-emerald-600/10 transition-all"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          {selectedDocType && documents.some(d => d.tipo === selectedDocType) && (
            ...
            <div className="glass-panel rounded-2xl border border-ink-200 overflow-hidden animate-fade-in">



              <div className="px-6 py-4 bg-ink-50/30 border-b border-ink-200 flex items-center justify-between">



                <h3 className="font-bold text-sm text-ink-700 flex items-center gap-2">
                ...
                <span className="text-[10px] font-mono bg-brand-50 text-brand-600 border border-brand-100 px-2.5 py-0.5 rounded-full font-bold">
              ...
              <div className="p-6 bg-white/20 flex flex-col items-center justify-center min-h-[220px] border-b border-slate-900">



                <div className="w-full bg-ink-50 border border-ink-200 rounded-xl p-5 shadow-2xl space-y-4 font-mono text-[10px] text-ink-500">



                  <div className="flex justify-between border-b border-ink-200 pb-2 text-[8px] text-ink-400">
                  ...
                  {selectedDocType === 'NOTA' ? (
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="text-center font-bold text-ink-700 text-xs border-b border-ink-200 pb-1.5 mb-3">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-ink-600">
                        ...
                        <div>RUC EMISOR: <span className="text-ink-700 font-semibold">1790012345001</span></div>



                        <div>TIPO: <span className="text-ink-700 font-semibold">NCD ({formData.tipo})</span></div>



                        <div className="sm:col-span-2">RUC BENEFICIARIO: <span className="text-ink-700 font-semibold">{formData.ruc}</span></div>



                        <div className="sm:col-span-2">AUTORIZACI├ôN: <span className="text-ink-700 font-semibold break-all">{formData.numero_autorizacion}</span></div>



                        <div>VALOR NOMINAL: <span className="text-emerald-700 font-bold">${formData.valor_nominal.toLocaleString('en-US', { minimumFractionDigits: 2 })}</span></div>



                        <div>SALDO DISPONIBLE: <span className="text-brand-600 font-bold">${formData.saldo_disponible.toLocaleString('en-US', { minimumFractionDigits: 2 })}</span></div>
                      ...
                      <div className="mt-4 border-t border-ink-200 pt-2 text-[8px] text-ink-400 italic">
                    ...
                    <div className="space-y-2 py-4 text-center text-ink-400">
                      ...
                      <p className="font-semibold text-xs text-ink-500">Documento {selectedDocType} cargado y validado</p>
          ...
          <div className="glass-panel rounded-2xl border border-ink-200 overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              ...
              <div 
                ...
                className={`p-6 border-2 border-dashed rounded-xl bg-white/20 text-center transition-all group relative overflow-hidden ${



                  isNewCase ? 'cursor-pointer border-brand-500/40 hover:border-brand-500/80 hover:bg-brand-500/5' : 'border-ink-200/80 hover:border-brand-500/40'
              ...
              >
                ...
                {isUploading ? (
                  ...
                  <div className="py-4 space-y-3">
                    ...
                    <div className="w-48 bg-ink-50 h-1.5 rounded-full mx-auto overflow-hidden">
                  ...
                  <div>
                    ...
                    <Upload className="w-8 h-8 text-brand-600 group-hover:scale-105 mx-auto mb-2 transition-transform" />
                  ...
                  <div>
                    ...
                    <Upload className="w-8 h-8 text-ink-400 group-hover:text-brand-600 mx-auto mb-2 transition-colors" />
                    ...
                    <div 
                      ...
                      className={`p-3 rounded-xl border flex items-center justify-between transition-all ${
                        ...
                        selectedDocType === type
                          ...
                          ? 'bg-ink-50 border-brand-500 text-ink-700 ring-1 ring-brand-500/10'
                          ...
                          : isPresent 
                            ...
                            ? 'bg-ink-50/40 border-ink-200/80 text-ink-700' 



                            : 'bg-white/40 border-dashed border-ink-200 text-ink-400 hover:border-ink-200'
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2.5 min-w-0">
                        ...
                        <div className="truncate">
                          ...
                          <div className={`text-xs font-bold tracking-wide ${isPresent ? 'text-ink-600' : 'text-ink-400'}`}>
                        ...
                        <button
                          ...
                          className={`p-1.5 rounded-lg border text-[10px] font-bold transition-all shrink-0 ${
                            ...
                            isPresent 
                              ...
                              ? 'bg-ink-50 border-ink-200 hover:bg-ink-200 hover:border-ink-300 text-ink-500 hover:text-ink-900' 



                              : 'bg-brand-50 border-brand-100 hover:bg-brand-500/20 text-brand-600 hover:text-brand-350'
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="glass-panel rounded-2xl border border-ink-200 overflow-hidden">
            ...
            <div className="px-6 py-4 bg-ink-50/30 border-b border-ink-200">
                      ...
                      <label className="text-xs font-semibold text-ink-500 uppercase tracking-wider flex items-center gap-1.5">
                        ...
                        <span className={`text-[8px] px-1.5 py-0.5 rounded font-bold ${
                          ...
                          source === 'IA' 
                            ...
                            ? 'bg-brand-50 text-brand-600 border border-brand-500/10'
                            ...
                            : source === 'REUTILIZADO'
                              ...
                              : 'bg-ink-200 text-ink-500 border border-ink-300'
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {isOperador && (
                          ...
                          <button
                            ...
                            className="text-ink-400 hover:text-ink-600 p-1 hover:bg-ink-50 rounded"
                        ...
                        <button
                          ...
                          className={`flex items-center gap-0.5 px-2 py-0.5 rounded-md text-[10px] font-bold border transition-all ${
                            ...
                            isConfirmed 
                              ...
                              : 'bg-white border-ink-200 text-ink-400 hover:border-slate-750 hover:text-ink-500'
                    ...
                    {isEditingField ? (
                      ...
                      field.type === 'select' ? (
                        ...
                        <select
                          ...
                          className="w-full px-3 py-1.5 bg-white border border-ink-200 focus:border-brand-500/60 rounded-xl text-sm text-ink-700 focus:outline-none transition-colors"
                      ...
                      <div className="px-3 py-2 bg-ink-50/60 border border-ink-200/80 rounded-xl text-sm text-ink-700 font-mono flex items-center justify-between">
                        ...
                        <span>
                          ...
                          {field.type === 'number' 
                            ...
                            : (value as string) || <span className="text-ink-400 font-sans text-xs italic">Pendiente de extracci├│n</span>
          ...
          <div className="glass-panel rounded-2xl border border-ink-200 overflow-hidden">
            ...
            <div className="px-6 py-4 bg-ink-50/30 border-b border-ink-200 flex items-center justify-between">
              ...
              {!isNewCase && (
                ...
                <span className="px-2.5 py-0.5 rounded-full text-xs font-mono font-bold bg-ink-50 border border-ink-200 text-ink-500">
            ...
            <div className="p-6 space-y-4">
              ...
              {isNewCase ? (
                ...
                <div className="py-6 text-center text-ink-400 text-xs flex flex-col items-center justify-center space-y-2">
                  ...
                  <p className="font-semibold text-ink-600">Evaluaci├│n de Riesgos Pendiente</p>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-ink-600 font-medium leading-relaxed">{risk.descripcion}</p>
                ...
                <div className="py-6 text-center text-ink-400 text-xs flex flex-col items-center justify-center space-y-2">
                  ...
                  <p className="font-semibold text-ink-600">Sin riesgos detectados</p>
              ...
              {showFocusMode && lowerRisks.length > 0 && (
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-1.5 py-2 hover:bg-ink-50 border border-transparent hover:border-ink-200 text-ink-500 hover:text-ink-600 rounded-xl text-xs font-semibold transition-all mt-4"
          ...
          {isNewCase ? (
            ...
            <div className="glass-panel rounded-2xl border border-ink-200 overflow-hidden glow-brand">
              ...
              <div className="p-6 space-y-4 text-xs">
                ...
                <div className="p-4 bg-ink-50/50 border border-ink-200 rounded-xl space-y-2">



                  <span className="text-[9px] uppercase font-bold text-ink-400">Nota a Generar:</span>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3 bg-emerald-600 hover:bg-emerald-500 active:bg-emerald-700 text-ink-900 rounded-xl text-xs font-semibold shadow-lg shadow-emerald-600/10 transition-all duration-150 font-bold"
            ...
            <div className="glass-panel rounded-2xl border border-ink-200 overflow-hidden glow-brand">
              ...
              <div className="px-6 py-4 bg-ink-50/30 border-b border-ink-200 flex items-center justify-between">
                ...
                <span className="px-1.5 py-0.5 rounded bg-brand-50 text-brand-600 border border-brand-100 text-[9px] font-bold">
              ...
              <div className="p-6 space-y-4 text-xs">
                ...
                <div className="p-4 bg-brand-500/5 border border-brand-100 rounded-xl space-y-2.5">
                  ...
                  {sugerencia.rango_descuento_sugerido && (
                    ...
                    <div className="text-[10px] font-semibold text-ink-500 flex items-center gap-1.5 bg-white/80 px-2.5 py-1.5 rounded-lg w-max border border-ink-200">
                ...
                {expediente.estado !== 'CERRADO' && expediente.estado !== 'CANCELADO' && expediente.estado !== 'RECHAZADO' && (
                  ...
                  isOperador ? (
                    ...
                    <button
                      ...
                      className={`w-full flex items-center justify-center gap-1.5 py-2.5 rounded-xl text-xs font-semibold shadow-lg transition-all duration-150 ${
                        ...
                        sugerencia?.codigo_accion === 'VERIFICAR_ENDOSOS'
                          ...
                          ? 'bg-ink-100 text-slate-550 border border-ink-200 cursor-not-allowed shadow-none'



                          : 'bg-brand-600 hover:bg-brand-500 active:bg-brand-700 text-ink-900 hover:shadow-brand-500/10'
                    ...
                    <div className="text-center text-slate-550 italic text-[11px] py-1 border-t border-ink-200/60 mt-2">
      ...
      {isActionModalOpen && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-white/80 backdrop-blur-sm animate-fade-in">
          ...
          <div className="w-full max-w-md glass-panel rounded-2xl border border-ink-200 shadow-2xl overflow-hidden">



            <div className="px-6 py-4 bg-ink-50/40 border-b border-ink-200/80 flex items-center justify-between">
              ...
              <button
                ...
                className="text-ink-500 hover:text-slate-250 text-xs"
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="p-4 bg-ink-50/50 border border-ink-200 rounded-xl space-y-2">
                ...
                <span className="text-[9px] uppercase font-bold text-ink-400">Transici├│n Propuesta:</span>
                ...
                <div className="flex items-center gap-2.5 text-xs">
                  ...
                  <span className="px-2 py-0.5 rounded font-mono border border-ink-200 bg-white text-ink-500">
                  ...
                  <span className="text-ink-400">ÔåÆ</span>



                  <span className="px-2 py-0.5 rounded font-mono border border-brand-100 bg-brand-50 text-brand-600 font-bold">
              ...
              <div className="space-y-1.5">
                ...
                <label className="text-xs font-semibold text-ink-500 uppercase tracking-wide">Comentarios / Observaciones</label>
                ...
                <textarea
                  ...
                  className="w-full h-24 px-3 py-2 bg-white border border-ink-200 focus:border-brand-500/60 rounded-xl text-sm text-ink-700 placeholder-slate-650 focus:outline-none transition-colors"
              ...
              <div className="pt-4 flex items-center justify-end gap-3 border-t border-ink-200/60">
                ...
                <button
                  ...
                  className="px-4 py-2 border border-ink-200 hover:border-ink-300 text-ink-500 hover:text-slate-250 rounded-xl text-sm font-semibold transition-all"
                ...
                <button
                  ...
                  className="px-4 py-2 bg-brand-600 hover:bg-brand-500 active:bg-brand-700 text-ink-900 rounded-xl text-sm font-semibold shadow-lg hover:shadow-brand-500/15 transition-all"
